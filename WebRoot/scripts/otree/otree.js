...
OTree.Node.prototype={
	initEl : function(){
		...
		this['html-element']['input']	 = document.createElement('span');
		...
		this['html-element']['element'].appendChild(this['html-element']['input']);
		...
		this['html-element']['input']['_type_'] ='hidden';
	...
	paintLine : function(){
		...
		for(var i = 1 ,count = pathNodes.length-1 ; i < count ; i++){//i=1: [0]是根节点,根节点没有clip
	...
	expand : function(){
		...
		this.paintIconImg();
		this.paintClipIcoImg();
		//adjust iframe height after click event on tree
